...
import RadioCommentItem from "./RadioCommentItem";

const RadioComments = ({ comments }) => {
    return (
        ...
        <View style={{ paddingTop: 10 }}>
            <ScrollView nestedScrollEnabled style={{ height: 500 }}>
                <FlatList
                    ...
                    data={comments}
                    renderItem={({ item }) => <RadioCommentItem comment={item} />}
                />
                <Row styles={{ justifyContent: "center" }}>
                    <CustomText fontSize={14} style={{ color: "#8878EF" , marginBottom:5 }}>
                        مشاهده همه نظرات
                    </CustomText>
                </Row>
            </ScrollView>
