...
import WGamesCommentItemomponent from "./WGamesCommentItemomponent";
import { Icon } from "../../appsetting/icons";

const WGamesCommentsComponent = ({ comments }) => {
  return (
      ...
      <View style={{ paddingTop: 10 }}>
        <ScrollView nestedScrollEnabled style={{ height: 500 }}>
          <FlatList
            ...
            data={comments}
            renderItem={({ item }) => <WGamesCommentItemomponent comment={item} />}
          />
...
export default WGamesCommentsComponent;
