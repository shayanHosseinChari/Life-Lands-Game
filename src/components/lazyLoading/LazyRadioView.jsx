...
const LazyRadioViewer = ()=>{
 ...
 <FlatList
     ...
     <TouchableOpacity  style={{width:150,height:160,paddingVertical:3,marginHorizontal:15,display:"flex",}}>
      ...
      <View style={{width:40,height:40,justifyContent:"center",borderRadius:100,alignItems:"center",backgroundColor:"#323232",position:"absolute",left:-7,bottom:-3}}>
      ...
      <View style={{width:'70%',height:5,borderRadius:10,backgroundColor:"#232323",marginHorizontal:5,marginTop:6,alignSelf:'center'}}></View>
...
export default LazyRadioViewer