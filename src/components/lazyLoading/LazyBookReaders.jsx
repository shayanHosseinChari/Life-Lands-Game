...
const LazyBookReaders = ()=>{
 ...
 <FlatList
     ...
     <TouchableOpacity  style={{width:110,height:170,paddingVertical:3,marginHorizontal:15,display:"flex",}}>
      <View style={{width:"100%",height:'90%',borderRadius:8,backgroundColor:"#131212",position:"relative"}}>
        <View style={Styles.profile}>
            <AntDesign name="user" size={30}  color={'rgb(71, 71, 71)'}/>
        </View>
...
export default LazyBookReaders