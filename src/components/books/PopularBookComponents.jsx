...
import PopularBookComponentsItems from "./PopularBookComponentsItems";

const PopularBookComponents = ({ title, books, navigation }) => {
  return (
    <SpaceStyle top={20}>
      <SpaceBetween>
      ...
      <FlatList
        ...
        data={books}
        renderItem={({ item }) => <PopularBookComponentsItems item={item} navigation={navigation} />}
      />
    </SpaceStyle>
  );
};
export default PopularBookComponents;
