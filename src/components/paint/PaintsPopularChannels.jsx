...
import PaintsPopularChannelItems from "./PaintsPopularChannelItems";

const PaintsPopularChannels = ({ title, paints, navigation }) => {
  return (
    <SpaceStyle top={20}>
      <SpaceBetween>
      ...
      <FlatList
        ...
        data={paints}
        renderItem={({ item }) => <PaintsPopularChannelItems item={item} navigation={navigation} />}
      />
    </SpaceStyle>
  );
};
export default PaintsPopularChannels;
