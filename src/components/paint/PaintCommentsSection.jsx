...
import PaintCommentItemSection from "./PaintCommentItemSection";

const PaintCommentsSection = ({ comments }) => {
    return (
            ...
            <View style={{ paddingTop: 10 }}>
                <ScrollView nestedScrollEnabled style={{ height: 500 }}>
                    <FlatList
                        ...
                        data={comments}
                        renderItem={({ item }) => <PaintCommentItemSection comment={item} />}
                    />
...
export default PaintCommentsSection;
const styles = StyleSheet.create({
    writeContainer: {
        color:"white",

        backgroundColor: "#48371D",
        borderRadius: 5,
        marginHorizontal: 10,
    },
});
