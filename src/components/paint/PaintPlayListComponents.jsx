...
import PaintPlayListComponentItems from "./PaintPlayListComponentItems";

const PaintPlayListComponents = ({ title, paints, navigation }) => {
  return (
    <SpaceStyle top={20}>
      <SpaceBetween>
      ...
      <FlatList
        ...
        data={paints}
        renderItem={({ item }) => <PaintPlayListComponentItems item={item} navigation={navigation} />}
      />
    </SpaceStyle>
  );
};
export default PaintPlayListComponents;
