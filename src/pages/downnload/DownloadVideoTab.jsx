...
const DownloadVideoTab = ({ navigation }) => {
  ...
  useEffect(() => {
    getAllVideos(forceUpdate, (v) => {
      setVideos(v);
    });
  }, [isFocused]);
  const getFile = async (item) => {
    navigation.navigate("Video Player", { item });
  };
  return (
    <ScrollView>
...
export default DownloadVideoTab;
