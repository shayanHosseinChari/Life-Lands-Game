    ...
    let result = await DocumentPicker.getDocumentAsync({
      ...
      if(result.canceled == true){
        ...
        if(result.assets[0].mimeType == "video/mp4"){
          navigation.navigate('See Story',{data: {uri: result.assets[0].uri,type:"Video",department:'social_post'}})
    ...
    <View style={styles.container}>
      ...
      >
        ...
        onEditingComplete={async(result) => {
          ...
          navigation.navigate('See Story',{data: {uri: result.uri,type:"image",department: "social_post"}})
